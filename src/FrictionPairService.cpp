...
: surface_materials_(SurfaceTypes::NUM_SURFACE_TYPES)
...
void FrictionPairService::set_materials(const physx::PxMaterial& typical_material) {
    surface_materials_[SurfaceTypes::TYPICAL] = typical_material;
