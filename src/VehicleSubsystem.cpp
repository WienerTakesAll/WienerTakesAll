...
// VehicleSubsystem::VehicleSubsystem(
...
// void VehicleSubsystem::update(int sim_steps) {

// }

// PhysicsComponent<false> VehicleSubsystem::create_4w_vehicle(
//     int id,
